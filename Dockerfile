...
RUN composer require --prefer-dist macfly/yii2-oauth2-server "*" && composer require --prefer-dist guzzlehttp/guzzle && ./vendor/bin/codecept bootstrap
